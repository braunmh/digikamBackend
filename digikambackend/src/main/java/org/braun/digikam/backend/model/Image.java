...
public class Image {
    ...
    private Orientation orientationTechnical;

    public Image orientationTechnical(Orientation value) {
        setOrientationTechnical(value);
        return this;
    }
    ...
    public void setOrientationTechnical(Orientation value) {
        this.orientationTechnical = value;
        if (Orientation.angle0 == value || Orientation.angle180 == value) {
