...
public abstract class KeywordsApiService {
    public abstract Response findKeywordsByName( @NotNull String name,SecurityContext securityContext) throws NotFoundException;
    public abstract Response refreshKeywordsCache(SecurityContext securityContext) throws NotFoundException;
}
