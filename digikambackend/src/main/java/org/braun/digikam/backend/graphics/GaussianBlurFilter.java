...
public class GaussianBlurFilter extends AbstractFilter {
    ...
    /**
     * <p>
     * Creates a new blur filter with a default radius of 3.</p>
     */
    ...
    /**
     * <p>
     * Creates a new blur filter with the specified radius. If the radius is lower than 0, a radius of 0.1 will be used
     * automatically.</p>
     *
     ...
     * <p>
     * After this method is executed, dstPixels contains a transposed and filtered copy of srcPixels.</p>
     *
